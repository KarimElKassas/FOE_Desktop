...
// build image with zooming
  PhotoViewGalleryPageOptions _buildImage(BuildContext context, int index) {
    print("URL : ${widget.galleryItems[index]}\n");
    return PhotoViewGalleryPageOptions.customChild(
      child: !widget.isFile ?
      ReusableComponents.cachedImage(url: widget.galleryItems[index], borderRadius: BorderRadius.zero, fit: BoxFit.fitWidth) : FittedBox(
        //fit: BoxFit.fill,
