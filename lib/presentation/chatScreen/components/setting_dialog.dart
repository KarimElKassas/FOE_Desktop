      ...
      child: BlocConsumer<SettingCubit, SettingStates>(
        ...
        builder: (context, state) {
          ...
          return Directionality(
            textDirection: Constants.currentLocale == LanguageType.ARABIC.getValue() ? TextDirection.rtl : TextDirection.ltr,
            child: Container(
              width: MediaQuery.of(context).size.width * 0.4,
              height: MediaQuery.of(context).size.height * (2 / 3),
              margin: EdgeInsets.only(
                  bottom: AppSize.s8, left: Constants.currentLocale == LanguageType.ARABIC.getValue() ? 0 : 60, right: Constants.currentLocale == LanguageType.ARABIC.getValue() ? 60 : 0),
              child: Material(
